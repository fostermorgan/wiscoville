  ...
  <body>
    ...
    <div class="container">
      <div class="text-center">
        <h1 class="handwritten pb-5">Hand made in Eau Claire, Wisconsin</h1>
      </div>

      <!-- <div class="header">Our Promise</div> -->
      <div class="info text-center">
        When it comes to our hot sauce, the goal is simple: to provide a uniquely curated culinary experience, backed by only the best natural and locally-sourced ingredients. This isn’t your standard hot sauce. <strong>This is K&M’s.</strong>
      </div>

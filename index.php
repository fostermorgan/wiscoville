  ...
  <footer class="bg-light py-5 mx-auto mr-auto">
    <div class="container">
      <div class=" row">
        ...
        <!-- newsletter -->
      <div class="newsletter col-12 col-lg-6 text-center m-0 row">
        <form id="newsletterform" action="#" class="mt-0 mb-2" method="post" name="newsletter">
          ...
          <div class="input row m-0">
            <input type="text" class="button col-8" id="newsletteremail" name="newsletteremail" placeholder="NAME@EXAMPLE.COM" required>
            <input type="submit" class="button col-4" id="newsletterSubmit" name="newsletterSubmit" value="SIGN UP">
          </div>
        </form>
      </div>

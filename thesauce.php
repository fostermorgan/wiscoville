    ...
    <body>
      ...
      <div class="content container">
        <div class="header mb-5 text-center">
          Crafted with the utmost quality, we are exicted to introduce to you...
        </div>
        <div class="row">
          <div class="col-12 title pt-0 pr-0 pl-0 shadow">
            <div class="subheader text-left mb-3 orange text-center border border-dark">Honeybee's Sting</div>
            <div class="info text-left pr-3 pl-3">
